        ...
        <main className="flex-1 flex flex-col min-h-0 overflow-hidden p-[3px] pb-24 md:pb-8">
            <div className="flex-1 flex flex-col gap-3 overflow-y-auto no-scrollbar">
                ...
                <div className="flex-1 bg-white/40 backdrop-blur-xl rounded-xl shadow-lg overflow-hidden flex flex-col lg:flex-row min-h-0">
                    ...
                    {/* Right Details Pane */}
                    <div className="w-full lg:w-1/3 lg:max-w-sm border-t lg:border-t-0 lg:border-l border-white/50 flex flex-col shrink-0">
                         <div className="p-4 border-b border-white/50">
                            <h2 className="text-lg font-bold text-slate-800">{t('eventsOn')} {selectedDate.toLocaleDateString(language, { weekday: 'long', month: 'long', day: 'numeric' })}</h2>
                         </div>
                                 ...
                                 <div className="space-y-3">
                                    {eventsForSelectedDay.map(event => (
                                        <div 
                                            ...
                                            className="p-3 bg-white/60 rounded-lg flex items-start gap-3 cursor-pointer hover:bg-white/80 transition-colors active:scale-[0.98]"
                                        >
                                            <div className="flex items-center gap-3 flex-1">
                                                <div className={`mt-1 w-2 h-2 rounded-full bg-${event.color}-500 shrink-0`}></div>
